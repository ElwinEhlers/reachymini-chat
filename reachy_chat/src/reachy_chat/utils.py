...
from reachy_chat.camera_worker import CameraWorker
    ...
    if not args.no_camera:
        ...
        if args.head_tracker is not None:
            if args.head_tracker == "yolo":
                from reachy_chat.vision.yolo_head_tracker import HeadTracker
        ...
        if args.local_vision:
            try:
                from reachy_chat.vision.processors import initialize_vision_manager
